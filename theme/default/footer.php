...
<?php
    if(isset($addtionalCodes)) echo $addtionalCodes;
...
<!-- IMPORTANT: Do not reload jQuery here. It is already loaded in the head. -->

<!-- Load Bootstrap 5 Bundle JS (includes Popper) -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>

<!-- Your custom JS -->
<script>
    // If you have any tab functionality, update the data attribute selectors to use Bootstrap 5's data-bs-toggle.
    $(document).ready(function(){
        $('a[data-bs-toggle="tab"]').tab();
    });
</script>
</body>
</html>
